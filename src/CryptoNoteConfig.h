...
const size_t   CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE     = 10; //size of block (bytes) after which reward for block calculated using block size
...
const char     CRYPTONOTE_NAME[]                             = "213COIN";
